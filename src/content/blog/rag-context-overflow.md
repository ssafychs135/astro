...
### 🔍 문제 상황
수만 페이지의 사내 기술 문서를 임베딩하여 검색하는 과정에서 관련성이 낮은 문서들이 컨텍스트 윈도우를 차지하였다. 그 결과 답변의 질이 저하되는 현상이 발생하였다.

### 🛠 해결 방법: Multi-stage Retrieval
단순 유사도 검색 대신 2단계 재랭킹(Re-ranking) 과정을 도입하였다.
...
### ✅ 결과
답변의 정확도가 기존 대비 약 35% 향상되었으며, 불필요한 토큰 소비를 줄여 운영 비용을 절감하였다.
